...
create table public.products (
    ...
    name text not null,
    slug text not null unique,
    mpn text, -- Número de parte del fabricante
    ean text, -- Número de artículo europeo
    image_url text,
    specs jsonb default '{}'::jsonb not null, -- Especificaciones flexibles
    created_at timestamp with time zone default timezone('utc'::text, now()) not null,
...
create table public.listings (
    ...
    url text not null,
    external_id text, -- ID interno de la tienda
    price_cash integer, -- Precio efectivo
    price_normal integer, -- Precio normal
