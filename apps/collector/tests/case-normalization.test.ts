...
describe("Case Title Normalizer", () => {
	describe("Corsair cases", () => {
		...
		it("should normalize 3500X", () => {
			const result = normalizeCaseTitle(
				"Gabinete Gamer Corsair 3500X, Vidrio Templado, USB-C, E-ATX, Color Negro",
			);
	...
	describe("Antec cases", () => {
		it("should normalize AX27 ELITE", () => {
			const result = normalizeCaseTitle(
				"GABINETE ANTEC AX27 ELITE BK ATX 4 FAN 0-761345-10205-6",
			);
		...
		it("should normalize C8 WOOD", () => {
			const result = normalizeCaseTitle(
				"GABINETE ANTEC C8 WOOD 0-761345-10079-3",
			);
		...
		it("should normalize C7 ARGB White", () => {
			const result = normalizeCaseTitle(
				"ANTEC GABINETE C7 ARGB White ( 1ARGB 140MM Y 3 ARGB 120MM ) 0-761345-10136-3",
			);
		...
		it("should normalize CX700 ARGB", () => {
			const result = normalizeCaseTitle(
				"GABINETE ANTEC CX700 ARGB BK P/N 0-761345-10120-2",
			);
	...
	describe("Cooler Master cases", () => {
		it("should normalize MasterBox MB520 Mesh", () => {
			...
			expect(result).toBe(
				"Cooler Master MasterBox MB520 Mid Tower TG Mesh RGB Blanco",
			);
		});
		...
		it("should normalize HAF 500", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER COOLER MASTER BLACK HAF 500 H500-KGNN-S00 P/N H500-KGNN-S00",
			);
		...
		it("should normalize Elite 302 White", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER COOLER MASTER ELITE 302 WHITE E302-WGNN-S00",
			);
	...
	describe("Be quiet! cases", () => {
		...
		it("should normalize Shadow Base 800DX Window White", () => {
			...
			expect(result).toBe(
				"Be quiet! Shadow Base 800DX Window Full Tower ARGB Blanco",
			);
		});
	...
	describe("XPG/ADATA cases", () => {
		it("should normalize Cruiser ST White", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER ADATA XPG CRUISER ST BLANCO P/N CRUISERST-WHCWW",
			);
		...
		it("should normalize Defender Pro Negro", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER ADATA XPG DEFENDER PRO NEGRO P/N DEFENDERPRO-BKCWW",
			);
		...
		it("should normalize Defender Negro E-ATX", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER ADATA XPG DEFENDER NEGRO E-ATX P/N DEFENDER-BKCWW",
			);
	...
	describe("Cougar cases", () => {
		...
		it("should normalize Duoface RGB White", () => {
			const result = normalizeCaseTitle(
				"GABINETE COUGAR DUOFACE RGB WHITE 385ZD10.0003",
			);
	...
	describe("Gigabyte cases", () => {
		it("should normalize C500 Panoramic Stealth Ice", () => {
			...
			expect(result).toBe(
				"Gigabyte C500 Panoramic Stealth Ice Mid Tower Blanco",
			);
		});
	...
	describe("ASUS cases", () => {
		...
		it("should normalize A31 TG White", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER ASUS A31 TG WHITE 90DC00R3-B08000",
			);
	...
	describe("Gamemax cases", () => {
		it("should normalize Starlight 2AB", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMEMAX STARLIGHT 2AB SIN FUENTE ATX",
			);
		...
		it("should normalize Blade Concept", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMEMAX BLADE CONCEPT BK ATX 1 USB-C",
			);
	...
	describe("APNX cases", () => {
		it("should normalize Creator C1 ARGB White", () => {
			const result = normalizeCaseTitle(
				"Gabinete Gamer Premium APNX Creator C1 ARGB, Color Blanco",
			);
		...
		it("should normalize Creator C1 ChromaFlair Limited Edition", () => {
			...
			expect(result).toBe(
				"APNX Creator C1 ChromaFlair Limited Edition Mid Tower ARGB",
			);
		});
	});
	...
	describe("Clio cases", () => {
		...
		it("should normalize Mado", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER CLIO MADO VIDRIO TEMPLADO 2USB 3.0 ATX",
			);
		...
		it("should normalize P3B", () => {
			const result = normalizeCaseTitle(
				"GABINETE GAMER CLIO P3B 3 FAN ARGB 2USB 3,0 ATX",
			);
