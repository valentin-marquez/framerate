...
describe("CPU Cooler Title Normalization", () => {
  describe("AIO Liquid Coolers", () => {
    test("Cooler Master MasterLiquid 360 Core II White", () => {
      const input = "REFRIGERACION LIQUIDA COOLER MASTER MASTERLIQUID 360 CORE II WHITE EDITION MLW-D36M-A18PA-RW";
    ...
    test("Cooler Master MasterLiquid 240 Core II ARGB", () => {
      const input = "REFRIGERACION LIQUIDA COOLER MASTER MASTERLIQUID 240 CORE II ARGB MLW-D24M-A18PA-R1";
    ...
    test("NZXT Kraken Elite 240 LCD Black", () => {
      const input = 'REFRIGERACION LIQUIDA NZXT Kraken Elite 240 2.72" IPS LCD BLACK P/N RL- KN24E-B2';
    ...
    test("NZXT Kraken Plus 240 V2 White", () => {
      const input = 'REFRIGERACION LIQUIDA NZXT Kraken Plus 240 1.54" LCD & RGB V2 White P/N RL- KR240-W2';
    ...
    test("Antec Neptune 120 ARGB", () => {
      const input = "SISTEMA DE REFRIGERACION LIQUIDA ANTEC WATERCOOLING * 120 * NEPTUNE 120 ARGB P/N 0-761345-74026-5";
    ...
    test("Gigabyte AORUS Waterforce X II 240", () => {
      const input = "SISTEMA DE REFRIGERACION LIQUIDA GIGABYTE AORUS WATERFORCE X II 240 P/N GP-AORUSWATERFORCEXII240";
    ...
    test("Gamdias Chione E1A-120 ARGB", () => {
      const input = "SISTEMA DE REFRIGERACION LIQUIDA GAMDIAS CHIONE E1A-120 ARGB WATERCOOLING P/N CHIONE E1A-120";
    ...
    test("Cougar Helor 240 RGB", () => {
      const input = "SISTEMA DE REFRIGERACION LIQUIDA COUGAR Watercooling Helor 240mm Dynamic RGB P/N 35CCL24.0004";
    ...
    test("Cooler Master ML280 Mirror", () => {
      const input = "REFRIGERACION LIQUIDA WATER COOLING COOLER MASTER MASTERLIQUID ML280 MIRROR P/N MLX-D28M-A14PK-R1";
  ...
  describe("Air Coolers", () => {
    test("Cougar Forza 85 ARGB", () => {
      const input = "Disipador para CPU COUGAR Forza 85 ARGB - Disipador de Torre Única con Iluminación ARGB";
    ...
    test("Cougar Forza 50 Essential", () => {
      const input = "Disipador para CPU COUGAR Forza 50 Essential - Disipador de Torre para CPU de Nivel Básico";
    ...
    test("Be Quiet! Dark Rock Pro 5", () => {
      const input = "Disipador de Procesador Be Quiet! Dark Rock Pro 5, 2 Ventiladores PWM, 7 Heatpipes, Negro";
    ...
    test("Gamemax Sigma 520 Digital White", () => {
      const input = "VENTILADOR PARA CPU GAMEMAX SIGMA 520 DIGITAL WHITE ( S1700 y AM5 ) P/N SIGMA520DIGITALWHITE";
    ...
    test("Gamemax Ice Surface White", () => {
      const input = "VENTILADOR PARA CPU GAMEMAX ICE SURFACE WHITE ( S1700 y AM4 ) P/N ICE-SURFACE-WH";
    ...
    test("XYZ Thermax 6 Pro Duo Black", () => {
      const input = "Disipador para CPU XYZ THERMAX 6 PRO DUO, 2x 120mm, 6 Heatpipes, Pantalla T°, Intel/AMD, Negro";
  ...
  describe("Edge Cases", () => {
    ...
    test("Should handle WHITE spelled as WITHE (typo)", () => {
      const input = "SISTEMA DE REFRIGERACION LIQUIDA ANTEC VORTEX LUM 360 ARGB WITHE 0-761345-40056-5";
