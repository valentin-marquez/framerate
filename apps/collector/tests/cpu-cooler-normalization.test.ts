...
describe("CPU Cooler Title Normalization", () => {
	describe("AIO Liquid Coolers", () => {
		...
		test("Antec Skeleton 360 ARGB Black", () => {
			const input =
				"REFRIGERACION LIQUIDA ANTEC SKELETON 360 ARGB BK P/N 0-761345-40066-4";
		...
		test("Antec Vortex Lum 240 ARGB", () => {
			const input =
				"REFRIGERACION LIQUIDA ANTEC VORTEX LUM 240 ARGB NEGRO 0-761345-40054-1";
		...
		test("Gigabyte AORUS Waterforce X II 240", () => {
			...
			const result = normalizeCpuCoolerTitle(
				input,
				"GP-AORUS WATERFORCE X II 240",
			);
	...
	describe("Air Coolers", () => {
		...
		test("Be Quiet! Pure Rock 3 LX ARGB", () => {
			const input =
				"Disipador CPU Be quiet! Pure Rock 3 LX, 190W TDP, 120mm, ARGB, 31.2 dB";
		...
		test("Gamemax Gamma 200 RGB", () => {
			const input =
				"VENTILADOR PARA CPU ARGB GAMEMAX GAMMA 200 RGB P/N GAMMA 200";
		...
		test("Morpheus G20 RGB", () => {
			const input =
				"Disipador para CPU Morpheus G20 RGB, Intel/AMD, Ventilador 92mm, RGB";
		...
		test("Morpheus Gaming A100 ARGB", () => {
			const input =
				"Disipador para CPU Morpheus Gaming A100 ARGB, Intel/AMD, 120mm";
		...
		test("Intel Original LGA1700", () => {
			const input =
				"VENTILADOR PARA CPU INTEL ORIGINAL BASE COBRE s1700 P/n M23901-001";
	...
	describe("Edge Cases", () => {
		test("Should remove verbose descriptors", () => {
			const input =
				"SISTEMA DE REFRIGERACION LIQUIDA ANTEC Symphony 360 ARGB WATERCOOLING";
		...
		test("Should handle typos in source data", () => {
			const input =
				"SISTEMA DE REGRIGERACION LIQUIDA ANTEC VORTEX 360 ARGB WATERCOOLING";
		...
		test("Should handle adapter products", () => {
			const input =
				"ADAPTADOR COOLER MASTER LGA1700 PARA WATER COOLING P/N 603005870-GP";
