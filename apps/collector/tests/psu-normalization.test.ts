...
describe("PSU Title Normalization", () => {
  ...
  test("normalizes Gamemax PSUs", () => {
    ...
    expect(normalizePsuTitle("Gamemax GX-1050 3.0 GX-1050BLACK3.0 80+ Gold")).toBe(
      "Gamemax GX-1050 1050W 80+ Gold",
    );
  });
  ...
  test("normalizes Cooler Master PSUs", () => {
    expect(
      normalizePsuTitle("Cooler Master MWE Gold V3 MPX-7503-AFAG-2EBWO 750W 80+ Gold Modular"),
  ...
  test("normalizes generic/other brands", () => {
    expect(
      normalizePsuTitle("FUENTE DE PODER 650W 20+4 2 SATA 2 MOLEX CLIO CON SWITCH CORTE 220V"),
    ).toBe("Clio 650W");
