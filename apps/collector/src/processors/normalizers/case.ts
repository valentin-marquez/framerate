...
function extractFormFactor(title: string): string | null {
  ...
  if (titleUpper.includes("MID TOWER") || titleUpper.includes("MID-TOWER") || titleUpper.includes("MIDTOWER")) {
    return "Mid Tower";
  }
  if (titleUpper.includes("MINI TOWER") || titleUpper.includes("MINI-TOWER") || titleUpper.includes("MINITOWER")) {
    return "Mini Tower";
  }
  ...
  if (titleUpper.includes("E-ATX") || titleUpper.includes("EATX") || titleUpper.includes("ATX EXTENDIDA")) {
    return "Full Tower";
  }
  ...
  if ((titleUpper.includes("GABINETE") && titleUpper.includes("GAMER")) || titleUpper.includes("GAMING CASE")) {
    return "Mid Tower";
  }
