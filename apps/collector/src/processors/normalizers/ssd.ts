...
function extractSsdFormat(title: string): string | null {
  ...
  if (titleUpper.includes('2.5"') || titleUpper.includes("2.5''") || titleUpper.includes("2,5"))
    return '2.5"';
...
function extractSsdBus(title: string): string | null {
  ...
  if (titleUpper.includes("PCIE 5") || titleUpper.includes("GEN5") || titleUpper.includes("GEN 5"))
    return "PCIe 5.0";
  if (titleUpper.includes("PCIE 4") || titleUpper.includes("GEN4") || titleUpper.includes("GEN 4"))
    return "PCIe 4.0";
  if (titleUpper.includes("PCIE 3") || titleUpper.includes("GEN3") || titleUpper.includes("GEN 3"))
    return "PCIe 3.0";
