...
export const RamProcessor = {
	normalize(rawSpecs: Record<string, string>, title = ""): RamSpecs {
		...
		return {
			...
			latency_cl:
				rawSpecs.latency_cl ||
				rawSpecs.latencia_cl ||
				rawSpecs["latencia cl (cas)"] ||
				rawSpecs.latencia_cl_cas ||
				"",
			latency_trcd:
				rawSpecs.latency_trcd ||
				rawSpecs.latencia_trcd ||
				rawSpecs["latencia trcd"] ||
				"",
			latency_trp:
				rawSpecs.latency_trp ||
				rawSpecs.latencia_trp ||
				rawSpecs["latencia trp"] ||
				"",
			latency_tras:
				rawSpecs.latency_tras ||
				rawSpecs.latencia_tras ||
				rawSpecs["latencia tras"] ||
				"",
			ecc_support: parseBoolean(
				rawSpecs.ecc_support ||
					rawSpecs.soporte_ecc ||
					rawSpecs["soporte ecc"] ||
					"",
			),
			full_buffered: parseBoolean(
				rawSpecs.full_buffered ||
					rawSpecs.soporte_full_buffered ||
					rawSpecs["soporte full buffered"] ||
					"",
			),
		};
	},
