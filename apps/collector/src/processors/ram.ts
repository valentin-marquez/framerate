  ...
  normalize(rawSpecs: Record<string, string>, title = ""): RamSpecs {
    ...
    return {
      ...
      latency_cl:
        ...
        "",
      latency_trcd:
        rawSpecs.latency_trcd || rawSpecs.latencia_trcd || rawSpecs["latencia trcd"] || "",
      latency_trp: rawSpecs.latency_trp || rawSpecs.latencia_trp || rawSpecs["latencia trp"] || "",
      latency_tras:
        rawSpecs.latency_tras || rawSpecs.latencia_tras || rawSpecs["latencia tras"] || "",
      ecc_support: parseBoolean(
        rawSpecs.ecc_support || rawSpecs.soporte_ecc || rawSpecs["soporte ecc"] || "",
      ),
