...
export const SsdProcessor = {
  normalize(rawSpecs: Record<string, string>, title = ""): SsdSpecs {
    ...
    const spDigitalM2Size =
      rawSpecs["Tamaño de la unidad SSD M.2"] || rawSpecs["tamaño de la unidad ssd m.2"] || "";
    ...
    const spDigitalReadSpeed =
      rawSpecs["Velocidad de lectura"] || rawSpecs["velocidad de lectura"] || "";
    const spDigitalWriteSpeed =
      rawSpecs["Velocidad de escritura"] || rawSpecs["velocidad de escritura"] || "";
    ...
    return {
      manufacturer:
        rawSpecs.manufacturer || rawSpecs.brand || rawSpecs.fabricante || rawSpecs.marca || "",
      line: rawSpecs.line || rawSpecs.linea || rawSpecs.línea || titleLine || "",
      capacity:
        rawSpecs.capacity || rawSpecs.capacidad || capacityFromSpDigital || titleCapacity || "",
