...
function extractSidePanelFromTitle(title: string): string {
  ...
  if (titleUpper.includes("VIDRIO TEMPLADO") || titleUpper.includes("TEMPERED GLASS") || titleUpper.includes("TG")) {
  ...
  normalize(rawSpecs: Record<string, string>, title = ""): CaseSpecs {
    ...
    return {
      ...
      max_motherboard_size:
        ...
        titleFormFactor ||
        "",
      psu_included: rawSpecs.psu_included || rawSpecs.fuente_de_poder || rawSpecs["fuente de poder"] || "",
      side_panel: rawSpecs.side_panel || rawSpecs.panel_lateral || rawSpecs["panel lateral"] || titleSidePanel || "",
      color: rawSpecs.color || titleColor || "",
      illumination: rawSpecs.illumination || rawSpecs.iluminacion || rawSpecs.iluminación || titleIllumination || "",
      dimensions: rawSpecs.dimensions || rawSpecs.tamano || rawSpecs.tamaño || rawSpecs.dimensiones || "",
      max_gpu_length:
        ...
        "",
      max_cooler_height:
        rawSpecs.max_cooler_height || rawSpecs.alto_maximo_de_cooler || rawSpecs["alto máximo de cooler"] || "",
      weight: rawSpecs.weight || rawSpecs.peso || "",
      psu_position: rawSpecs.psu_position || rawSpecs.ubicacion_de_la_psu || rawSpecs["ubicación de la psu"] || "",
      expansion_slots: rawSpecs.expansion_slots || rawSpecs.slots_de_expansion || rawSpecs["slots de expansión"] || "",
      ...
      front_fans:
        rawSpecs.front_fans || rawSpecs.espacios_para_vent_frontales || rawSpecs["espacios para vent. frontales"] || "",
      rear_fans:
        rawSpecs.rear_fans || rawSpecs.espacios_para_vent_traseros || rawSpecs["espacios para vent. traseros"] || "",
      side_fans:
        rawSpecs.side_fans || rawSpecs.espacios_para_vent_laterales || rawSpecs["espacios para vent. laterales"] || "",
      top_fans:
        rawSpecs.top_fans || rawSpecs.espacios_para_vent_superiores || rawSpecs["espacios para vent. superiores"] || "",
      bottom_fans:
        ...
        "",
      included_fans:
        rawSpecs.included_fans || rawSpecs.ventiladores_incluidos || rawSpecs["ventiladores incluidos"] || "",
    };
  },
};
