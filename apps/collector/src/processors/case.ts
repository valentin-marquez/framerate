	...
	normalize(rawSpecs: Record<string, string>, title = ""): CaseSpecs {
		...
		return {
			...
			max_motherboard_size:
				...
				"",
			psu_included:
				rawSpecs.psu_included ||
				rawSpecs.fuente_de_poder ||
				rawSpecs["fuente de poder"] ||
				"",
			side_panel:
				rawSpecs.side_panel ||
			...
			drive_bays: parseList(
				rawSpecs.drive_bays || rawSpecs.bahias || rawSpecs.bahías || "",
			),
			front_fans:
				rawSpecs.front_fans ||
