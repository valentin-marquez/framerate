...
describe("Motherboard Title Normalization", () => {
  ...
  test("removes P/N and suffixes", () => {
    ...
    expect(normalizeMotherboardTitle("GIGABYTE B650 AORUS ELITE AX - ATX -")).toBe(
  ...
  test("handles SP Digital format", () => {
    expect(normalizeMotherboardTitle("GIGABYTE B650M GAMING WIFI, AM5, DDR5")).toBe(
      "Gigabyte B650M Gaming WiFi",
    );
  });

  test("handles ICE-P suffix", () => {
    expect(normalizeMotherboardTitle("GIGABYTE B650M AORUS ELITE AX ICE-P")).toBe(
