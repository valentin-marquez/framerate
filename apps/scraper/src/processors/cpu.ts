...
export const CpuProcessor = {
  normalize(rawSpecs: Record<string, string>): CpuSpecs {
    const frequency =
      rawSpecs.frequency || rawSpecs.frecuencia || rawSpecs["frecuencia del procesador"] || "";
    ...
    const cores =
      rawSpecs.cores || rawSpecs.núcleos || rawSpecs["número de núcleos de procesador"] || "";
    const threads =
      rawSpecs.threads || rawSpecs.hilos || rawSpecs["número de hilos de ejecución"] || "";
    ...
    return {
      manufacturer:
        rawSpecs.manufacturer || rawSpecs.fabricante || rawSpecs["familia de procesador"] || "",
      frequency,
