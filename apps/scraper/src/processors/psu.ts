...
export const PsuProcessor = {
  normalize(rawSpecs: Record<string, string>, productName?: string): PsuSpecs {
    ...
    let certification =
      rawSpecs.certification || rawSpecs.certificación || rawSpecs.certificacion || "";
    ...
    const rail12v =
      rawSpecs.rail_12v || rawSpecs.corriente_en_la_línea_de_12_v || rawSpecs.corriente_12v || "";

    const rail5v =
      rawSpecs.rail_5v || rawSpecs.corriente_en_la_línea_de_5_v || rawSpecs.corriente_5v || "";
