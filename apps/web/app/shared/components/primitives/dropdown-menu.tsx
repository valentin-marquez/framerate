    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 " +
              ...
              "ring-foreground/5 bg-popover text-popover-foreground min-w-48 rounded-lg p-1 shadow-2xl ring-1 " +
              "duration-100 z-50 max-h-(--available-height) w-(--anchor-width) origin-(--transform-origin) " +
              "overflow-visible " +
              "relative",
            className,
          )}
        ...
        >
          <div
            className={cn(
              "absolute size-3 rotate-45 bg-popover border border-foreground/5 z-50 pointer-events-none",
              "data-[side=bottom]:-top-1.5 data-[side=bottom]:left-4",
              "data-[side=top]:-bottom-1.5 data-[side=top]:left-4",
              "data-[side=left]:-right-1.5 data-[side=left]:top-4",
              "data-[side=right]:-left-1.5 data-[side=right]:top-4",
              "data-[side=bottom]:data-[align=center]:left-1/2 data-[side=bottom]:data-[align=center]:-translate-x-1/2",
              "data-[side=bottom]:data-[align=end]:left-auto data-[side=bottom]:data-[align=end]:right-4",
              "data-[side=top]:data-[align=center]:left-1/2 data-[side=top]:data-[align=center]:-translate-x-1/2",
              "data-[side=top]:data-[align=end]:left-auto data-[side=top]:data-[align=end]:right-4",
              "data-[side=left]:data-[align=center]:top-1/2 data-[side=left]:data-[align=center]:-translate-y-1/2",
              "data-[side=left]:data-[align=end]:top-auto data-[side=left]:data-[align=end]:bottom-4",
              "data-[side=right]:data-[align=center]:top-1/2 data-[side=right]:data-[align=center]:-translate-y-1/2",
              "data-[side=right]:data-[align=end]:top-auto data-[side=right]:data-[align=end]:bottom-4",
            )}
            data-side={side}
            data-align={align}
            aria-hidden="true"
...
function DropdownMenuSeparator({ className, ...props }: MenuPrimitive.Separator.Props) {
  return (
    <MenuPrimitive.Separator
      ...
      className={cn("bg-border/80 -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
