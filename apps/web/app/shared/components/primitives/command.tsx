...
import { InputGroup, InputGroupAddon } from "~/shared/components/primitives/input-group";
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className={cn("rounded-4xl! p-0 overflow-hidden p-0", className)}>
        {children}
        {showCloseButton && <DialogClose className="top-2 right-2" />}
      </DialogContent>
    </Dialog>
  );
}
