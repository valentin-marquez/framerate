		...
		>
			...
			<div className="relative z-10 flex h-full flex-col justify-between">
				<div className="max-w-[70%]">
					<h3 className="font-display text-xl font-bold text-white md:text-2xl tracking-tight">
						{title}
					</h3>
					{description && (
						<p className="mt-2 text-sm font-medium text-white/90 line-clamp-2 font-sans">
							{description}
						</p>
					)}
				</div>
